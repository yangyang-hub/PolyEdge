...
| `worker/rewards/live_sync.rs` | rewards live 托管订单成交/状态同步、单订单失败隔离、BalancedMerge fill/position 合并 intent 接线、Reset cancel-all 语义 |
