...
- 全市场 price-history/outcome producer、完整执行成本/多阶段退出回测、Phase 4 校准与漂移监控、Rewards 做市商引用 fair value 的 shadow/live 决策尚未实现；该模块不再作为独立 paper/live 执行器推进。
