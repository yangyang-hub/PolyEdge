...
- 数据库以已冻结的 `0001_initial_schema.sql` 为干净部署基线，`0002_reward_fair_value_history_identity.sql` 为现有部署提供 fair-value history 唯一索引升级；`packages/backend/init.sql` 始终表达最新完整 schema。
