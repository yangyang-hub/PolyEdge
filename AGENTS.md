...
| `packages/backend/crates/connectors/src/reward_ai_tests.rs` | Rewards AI advisory connector tests — 二值 `allow_quote` 解析和旧响应兼容 |
