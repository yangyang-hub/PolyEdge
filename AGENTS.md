...
| `packages/backend/apps/worker/src/worker/rewards/provider_refresh.rs` | Rewards AI advisory / info-risk provider refresh — 开放订单/持仓优先，普通候选与低竞争通过 gate 的 pre-AI 市场按约 2:1 混排，按 condition 先补 AI advisory 再补信息风险 |
