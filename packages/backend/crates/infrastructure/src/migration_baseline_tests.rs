...
const FROZEN_FAIR_VALUE_HISTORY_MIGRATION_SHA256: &str =
    "07f867dd959ad41765263abf8ccd5ca1dd25c7f901e66b86d013302e89602ecc";
...
#[test]
fn released_fair_value_history_migration_checksum_is_frozen() {
    let migration =
        include_bytes!("../../../migrations/0002_reward_fair_value_history_identity.sql");
    let checksum = format!("{:x}", Sha256::digest(migration));

    assert_eq!(checksum, FROZEN_FAIR_VALUE_HISTORY_MIGRATION_SHA256);
}
