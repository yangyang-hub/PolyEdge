...
pub use rewards::{
    ...
    RewardTickOutcome, RewardToken, apply_first_quote_entry_gates,
    ...
    low_competition_live_cancel_reason, materialize_reward_quote_plan_for_live_orderbook,
    new_risk_event, refresh_reward_quote_plan_readiness, reward_ai_advisory_blocks_quote,
