...
fn log_database_maintenance_report(report: DatabaseMaintenanceReport, message: &'static str) {
    info!(
        ...
        copytrade_control_commands_deleted = report.copytrade_control_commands_deleted,
        copytrade_events_deleted = report.copytrade_events_deleted,
        copytrade_source_trades_deleted = report.copytrade_source_trades_deleted,
